...
function DashboardUae() {
  ...
  async function fetchProducts(isRetry = false) {
    ...
    try {
      const response = await fetch("https://hipzonebackend.vercel.app/products/dubai/data")
  ...
  async function addProduct() {
    ...
    try {
      const response = await fetch("https://hipzonebackend.vercel.app/products/dubai", {
        method: "POST",
  ...
  async function updateProduct(id, name, price) {
    try {
      const response = await fetch(`https://hipzonebackend.vercel.app/products/dubai/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
